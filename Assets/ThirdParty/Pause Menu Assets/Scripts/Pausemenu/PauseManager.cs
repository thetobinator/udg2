...
namespace GreatArcStudios
{
    ...
    public class PauseManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// This is the controls panel holder, which displays the controls.
        /// </summary>
        ...
        public void Restart()
        {
            ...
            uiEventSystem.firstSelectedGameObject = defualtSelectedMain;
			Resume (); // resumes after restarting -- BILL
        }
        /// <summary>
        ...
        public void Update()
        {
            ...
            {
                pauseMenu.text = "uDeadGame";
            }

            if (Input.GetKeyDown(KeyCode.Escape) && mainPanel.activeSelf == false)
            {
                GameObject[] o = GameObject.FindGameObjectsWithTag("MainGameManager");
                if (o.Length >= 1)
                {
                    MainGameManager m = o[0].GetComponent<MainGameManager>();
                    m.showTextToggle = false;
                }
        ...
        public void Controls()
        {
            ...
            vidPanel.SetActive(false);
            audioPanel.SetActive(false);
            vidPanelAnimator.enabled = false;
            GameObject[] o = GameObject.FindGameObjectsWithTag("MainGameManager");
            if (o.Length >= 1)
            {
                MainGameManager m = o[0].GetComponent<MainGameManager>();
                m.showTextToggle = true;
            }
