...
namespace ProceduralToolkit.Examples
{
    ...
    public class Khrushchyovka : MonoBehaviour
    {
        ...
        private MeshDraft KhrushchyovkaDraft()
        {
            ...
            float grayColor = (wallColor.r - 0.4f) + (wallColor.g - 0.4f) + (wallColor.b - 0.4f) * 0.33f;
            Color grayValue = new Color(glassColor.r - grayColor, glassColor.g - grayColor, glassColor.b -grayColor, 1.0f);

           // Color grayValue = new Color(grayColor, grayColor, grayColor, 1.0f);

            //Color grayValue = new Color(wallColor.r-0.8f,  wallColor.g-0.8f,  wallColor.b - 0.8f, 1.0f);
            wallColor = grayValue; // new Color(grayValue, grayValue, grayValue, 1.0f);
        ...
        private static MeshDraft Windowpane(Vector3 origin, Vector3 width, Vector3 heigth)
        {
            ...
            glassColor = RandomE.colorHSV.WithA(0);
            float grayColor = (glassColor.r - 0.4f) + (glassColor.g - 0.4f) + (glassColor.b - 0.4f)* 0.33f;
            //Color grayValue = new Color(glassColor.r - 0.4f, glassColor.g - 0.4f, glassColor.b -0.4f, 1.0f);


            Color grayValue = new Color(grayColor, grayColor, grayColor, 1.0f);

           glassColor = grayValue; // new Color(grayValue, grayValue, grayVa
