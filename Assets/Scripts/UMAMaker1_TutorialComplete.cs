...
public class UMAMaker1_TutorialComplete: MonoBehaviour {
    ...
    //public List<string> umaObjects = new List<string>();
    ...
    void CreateMale()
    {
       ...
       // umaData.umaRecipe.slotDataList[6].SetOverlayList(umaData.umaRecipe.slotDataList[3].GetOverlayList());
        ...
        // adding at runtime after lesson part 10b
    ...
    // Practical Guide to UMA Part 9 Changing Shape at Runtime
    // https://youtu.be/FaPPR7hdZy8
