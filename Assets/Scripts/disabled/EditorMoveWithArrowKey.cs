...
{
    /*
     * //disabled because it conflicts with the duplication script with the same values active on the same objects
     * //because that script was sourced from this one.
[ExecuteInEditMode]
