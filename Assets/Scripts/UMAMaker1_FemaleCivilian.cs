...
public class UMAMaker1_FemaleCivilian: MonoBehaviour {
   ...
   /* [Range(0, 8)]
    ...
    void CreateFemale()
    {
        ...
        // seven basic slots
        umaData.umaRecipe.slotDataList[0] = slotLibrary.InstantiateSlot("FemaleEyes"); // mesh
        AddOverlay(0, "EyeOverlay"); // texture

        umaData.umaRecipe.slotDataList[1] = slotLibrary.InstantiateSlot("FemaleInnerMouth"); // mesh
        AddOverlay(1, "InnerMouth"); // texture

        umaData.umaRecipe.slotDataList[2] = slotLibrary.InstantiateSlot("FemaleFace"); // mesh
        AddOverlay(2, "FemaleHead01"); // texture

        umaData.umaRecipe.slotDataList[3] = slotLibrary.InstantiateSlot("FemaleTorso"); // mesh
        AddOverlay(3, "FemaleBody02"); // texture

        umaData.umaRecipe.slotDataList[4] = slotLibrary.InstantiateSlot("FemaleHands"); // mesh
        LinkOverlay(4, 3);

        umaData.umaRecipe.slotDataList[5] = slotLibrary.InstantiateSlot("FemaleLegs"); // mesh
        LinkOverlay(5, 3);
    
        //footSlot = 6
        umaData.umaRecipe.slotDataList[footSlot] = slotLibrary.InstantiateSlot("FemaleFeet"); // mesh
        LinkOverlay(footSlot, 3); 
    ...
    void LeftFistBox()
    {
        ...
        if (umaData.transform != null)
        {
            ...
            LeftHandCol.radius = 0.02f;
            LeftHandCol.height = .1f;
            ...
            LeftHandCol.center = new Vector3(-0.04f, -0.03f, -0.00f);
